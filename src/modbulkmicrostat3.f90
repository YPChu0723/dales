...
!
!  Copyright 1993-2026 Delft University of Technology, Wageningen University, Utrecht University, KNMI, NLeSC
!
    ...
    if (lnetcdf) then
      ...
      if (myid==0) then
        ...
        if (l_statistics) then
          ...
          call ncinfo(ncmname(cnt + iq_hr,:),'q_hr','Average water content of rain'           ,'kg/kg^-1','tt')
          call ncinfo(ncmname(cnt + in_cl,:),'n_cl','Average number content of cloud droplets','-','tt')
          call ncinfo(ncmname(cnt + iq_cl,:),'q_cl','Average water content of cloud droplets' ,'kg/kg^-1','tt')
          call ncinfo(ncmname(cnt + in_ci,:),'n_ci','Average number content of ice crystals'  ,'-','tt')
          call ncinfo(ncmname(cnt + iq_ci,:),'q_ci','Average water content of ice crystals'   ,'kg/kg^-1','tt')
          call ncinfo(ncmname(cnt + in_hs,:),'n_hs','Average number content of snow'          ,'-','tt')
          call ncinfo(ncmname(cnt + iq_hs,:),'q_hs','Average water content of snow'           ,'kg/kg^-1','tt')
          call ncinfo(ncmname(cnt + in_hg,:),'n_hg','Average number content of graupel'       ,'-','tt')
          call ncinfo(ncmname(cnt + iq_hg,:),'q_hg','Average water content of graupel'        ,'kg/kg^-1','tt')
          ...
          call ncinfo(ncmname(cnt + iq_hr,:),'q_hrp','Average tendency of water content of rain'           ,'kg/kg^-1','tt')
          call ncinfo(ncmname(cnt + in_cl,:),'n_clp','Average tendency of number content of cloud droplets','-','tt')
          call ncinfo(ncmname(cnt + iq_cl,:),'q_clp','Average tendency of water content of cloud droplets' ,'kg/kg^-1','tt')
          call ncinfo(ncmname(cnt + in_ci,:),'n_cip','Average tendency of number content of ice crystals'  ,'-','tt')
          call ncinfo(ncmname(cnt + iq_ci,:),'q_cip','Average tendency of water content of ice crystals'   ,'kg/kg^-1','tt')
          call ncinfo(ncmname(cnt + in_hs,:),'n_hsp','Average tendency of number content of snow'          ,'-','tt')
          call ncinfo(ncmname(cnt + iq_hs,:),'q_hsp','Average tendency of water content of snow'           ,'kg/kg^-1','tt')
          call ncinfo(ncmname(cnt + in_hg,:),'n_hgp','Average tendency of number content of graupel'       ,'-','tt')
          call ncinfo(ncmname(cnt + iq_hg,:),'q_hgp','Average tendency of water content of graupel'        ,'kg/kg^-1','tt')
          call ncinfo(ncmname(cnt + in_cc,:),'n_ccp','Average tendency of number content of ccn'           ,'-','tt')
          cnt = cnt + 11

          ! statistic_sv0_count(ncols,k1)
          call ncinfo(ncmname(cnt + 1,:),'q_hr_count','Count of water content of rain above threshold'           ,'kg/kg^-1','tt')
          call ncinfo(ncmname(cnt + 2,:),'q_cl_count','Count of water content of cloud droplets above threshold' ,'kg/kg^-1','tt')
          call ncinfo(ncmname(cnt + 3,:),'q_ci_count','Count of water content of ice crystals above threshold'   ,'kg/kg^-1','tt')
          call ncinfo(ncmname(cnt + 4,:),'q_hs_count','Count of water content of snow above threshold'           ,'kg/kg^-1','tt')
          call ncinfo(ncmname(cnt + 5,:),'q_hg_count','Count of water content of graupel above threshold'        ,'kg/kg^-1','tt')
          cnt = cnt + 5

          ! statistic_sv0_csum(ncols,k1)
          call ncinfo(ncmname(cnt + 1,:),'cn_hr','Average number content of rain above threshold'          ,'-','tt')
          call ncinfo(ncmname(cnt + 2,:),'cq_hr','Average water content of rain above threshold'           ,'kg/kg^-1','tt')
          call ncinfo(ncmname(cnt + 3,:),'cn_cl','Average number content of cloud droplets above threshold','-','tt')
          call ncinfo(ncmname(cnt + 4,:),'cq_cl','Average water content of cloud droplets above threshold' ,'kg/kg^-1','tt')
          call ncinfo(ncmname(cnt + 5,:),'cn_ci','Average number content of ice crystals above threshold'  ,'-','tt')
          call ncinfo(ncmname(cnt + 6,:),'cq_ci','Average water content of ice crystals above threshold'   ,'kg/kg^-1','tt')
          call ncinfo(ncmname(cnt + 7,:),'cn_hs','Average number content of snow above threshold'          ,'-','tt')
          call ncinfo(ncmname(cnt + 8,:),'cq_hs','Average water content of snow above threshold'           ,'kg/kg^-1','tt')
          call ncinfo(ncmname(cnt + 9,:),'cn_hg','Average number content of graupel above threshold'       ,'-','tt')
          call ncinfo(ncmname(cnt +10,:),'cq_hg','Average water content of graupel above threshold'        ,'kg/kg^-1','tt')
          ...
          call ncinfo(ncmname(cnt + 2,:),'cq_hrp','Average tendency of water content of rain above threshold'           ,'kg/kg^-1','tt')
          call ncinfo(ncmname(cnt + 3,:),'cn_clp','Average tendency of number content of cloud droplets above threshold','-','tt')
          call ncinfo(ncmname(cnt + 4,:),'cq_clp','Average tendency of water content of cloud droplets above threshold' ,'kg/kg^-1','tt')
          call ncinfo(ncmname(cnt + 5,:),'cn_cip','Average tendency of number content of ice crystals above threshold'  ,'-','tt')
          call ncinfo(ncmname(cnt + 6,:),'cq_cip','Average tendency of water content of ice crystals above threshold'   ,'kg/kg^-1','tt')
          call ncinfo(ncmname(cnt + 7,:),'cn_hsp','Average tendency of number content of snow above threshold'          ,'-','tt')
          call ncinfo(ncmname(cnt + 8,:),'cq_hsp','Average tendency of water content of snow above threshold'           ,'kg/kg^-1','tt')
          call ncinfo(ncmname(cnt + 9,:),'cn_hgp','Average tendency of number content of graupel above threshold'       ,'-','tt')
          call ncinfo(ncmname(cnt +10,:),'cq_hgp','Average tendency of water content of graupel above threshold'        ,'kg/kg^-1','tt')
